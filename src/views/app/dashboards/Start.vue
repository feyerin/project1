...
<div>
    <b-row>
        <b-colxx xxs="12">
            <piaf-breadcrumb :heading="$t('dashboards')" />
            <div class="separator mb-5"></div>
        </b-colxx>
    </b-row>
    <b-row>
        <b-colxx xl="12" lg="2" >
            <div class="icon-cards-row" style="margin-bottom:20px">
                <glide-component :settings="glideIconsOption">
                     <b-card style="height:192px" :title="$t('')">
                        <div class="dashboard-donut-chart">
                            <doughnut-shadow-chart :data="doughnutChartData" :height="180"  />
                        </div>
                    </b-card>
                    <icon-card :title="$t('Merchant PKP')" icon="iconsminds-clock" :value="14" :height="230" style="height:100px"/>
                    <icon-card :title="$t('Merchant Non-PKP')" icon="iconsminds-basket-coins" :value="32" />
                    <icon-card :title="$t('Incoming Order')" icon="iconsminds-arrow-refresh" :value="74" />
                    <!-- <icon-card :title="$t('Ongoing')" icon="iconsminds-mail-read" :value="25" /> -->
                    <icon-card :title="$t('Order Pasarjaya  ')" icon="iconsminds-mail-read" :value="25" />
                    <icon-card :title="$t('ongoing Pasarjaya')" icon="iconsminds-mail-read" :value="25" />
                </glide-component>
            </div>
            <b-row>
    ...
    <!-- <b-row>
        <b-colxx lg="4" md="12" class="mb-4">
            <b-card :title="$t('product categories')">
                <div class="dashboard-donut-chart">
        ...
        <b-colxx lg="4" md="6" class="mb-4">
            <b-card :title="$t('tickets')" class="dashboard-link-list">
        ...
        <b-colxx lg="4" md="6" class="mb-4">
            <b-card :title="$t('cakes')" class="dashboard-link-list">
